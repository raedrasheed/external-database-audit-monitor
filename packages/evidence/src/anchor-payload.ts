// Canonical anchor payload (Sprint-2 / EDAM-T110; logic from T120).
//
...
//
// Pure assembly only — NO private key material. Moved here (from @edam/signing)
// so the writer, the signing layer, AND the independent verifier share one
// byte-identical assembly without importing signing-private code.
