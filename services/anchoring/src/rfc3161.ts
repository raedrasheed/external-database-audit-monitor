...
//
// The pure RFC-3161 primitives (TstInfo signing bytes + the offline verifier +
// the proof/cert/result types) live in @edam/anchor-proof — shared with the
// independent verifier so there is ONE implementation and no builder<->verifier
// drift. This module is the KEY-HOLDING provider wrapper only.
//
...
import { tstSigningBytes, verifyRfc3161Token, type TstInfo, type DevTsaCertificate } from '@edam/anchor-proof';
